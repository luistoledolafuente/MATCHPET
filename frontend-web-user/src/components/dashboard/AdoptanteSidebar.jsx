  ...
  return (
    ...
    >
      ...
      <div className="flex items-center px-6 py-5 border-b border-[#407581]">
        ...
        />
        <span className="text-2xl font-extrabold text-[#407581] tracking-wide">
          MatchPet
        </span>
      </div>
      ...
      >
        {[
          ...
          <Link
            key={to}
            to={to}
            className="flex items-center px-4 py-3 text-[#407581] rounded-lg hover:bg-[#83c9f9] hover:text-white transition-colors duration-200 font-semibold shadow-sm"
          >
